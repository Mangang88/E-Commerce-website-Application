...
if(isset($_POST['insert_product'])) {
  ...
  if($product_title=='' || $description=='' || $product_keywords=='' || $product_category=='' || $product_brands=='' || $product_price=='' || $product_image1=='' || $product_image2=='' || $product_image3=='') { 
    ...
    // Insert query
    $insert_product_query="INSERT INTO `products` (product_title,product_description,product_keywords,category_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status) VALUES ('$product_title','$description','$product_keywords','$product_category','$product_brands','$product_image1','$product_image2','$product_image3','$product_price',NOW(),'$product_status')";
...
<div class="container mt-3">
  ...
  <!-- title -->
    ...
    <select name="product_categories" class="form-select">
      ...
      $result_categories=mysqli_query($con,$select_categories_query);
